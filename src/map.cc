...
void Map::ReadBackgroundImages() {
  std::string background_file =
      "C:/Users/devjw/CLionProjects/cinder_0.9.2_vc2015/projects/FPPrisonBreak/assets/background.txt";
...
void Map::ReadMaps() {
  ...
  std::string maze_file =
      "C:/Users/devjw/CLionProjects/cinder_0.9.2_vc2015/projects/FPPrisonBreak/assets/maze.txt";
